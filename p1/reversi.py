...
#     VvalidMove = []
#     for i in validBoard:
#         value, bestMove = self.pruning(i, maxdepth - 1, maxdepth, Alpha, Beta, -actcolor)
#         VvalidMove.append(value)
#     index = np.argsort(VvalidMove)
#     validMove = [validMove[i] for i in index[0:6]]
#     validBoard = [validBoard[i] for i in index[0:6]]
